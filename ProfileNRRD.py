...
fig1, axes = plt.subplots( nrows=2, ncols=2, constrained_layout=True,figsize=(15,15))
fig1.suptitle(exam)
axes[0, 1].scatter(widthTrack,horizontalProfile,s=15,c=(1,0,0))
axes[0, 1].plot(t,corProfile, 'c')
if matlabCompare:
    axes[0, 1].plot(t,mlCorProfile)
axes[0, 1].set_xlim(1,width)
axes[0, 1].set_ylim(-1000,1000)
axes[1, 0].scatter(testList,testTrack, s=15, c=(1,0,0))
axes[1, 0].plot(corTest, t, 'y')
...
axes[1, 1].plot(t,profileplot, 'c')
axes[1, 1].plot(profileplot, h, 'y')
